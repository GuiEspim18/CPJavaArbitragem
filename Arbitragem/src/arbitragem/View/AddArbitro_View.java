 ...
 * @author guiespim
 */
public class AddArbitro_View extends javax.swing.JFrame {
    
    private Home_View home; 

    /**
     * Creates new form AddArbitro_View
     */
    public AddArbitro_View(Home_View home) {
        initComponents();
        this.home = home;
    }
     
    public AddArbitro_View() {
        initComponents();
    }   
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Adicionar arbitro");
    ...
    private void adicionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_adicionarActionPerformed
        Arbitro_DAO arbitro = new Arbitro_DAO(Arbitros.getAll().size() + 1, nome.getText(), sobrenome.getText(), email.getText(), serie.getSelectedItem().toString(), esporte.getText(), experiencia.getText(), telefone.getText(), estado.getText(), status.getSelectedItem().toString());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddArbitro_View.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddArbitro_View().setVisible(true);
            }
        });
    }
